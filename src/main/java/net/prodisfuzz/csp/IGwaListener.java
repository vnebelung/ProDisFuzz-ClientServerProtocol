...
/**
 * This interface represents a listener for the GWA command.
 */
public interface IGwaListener {

    /**
     * Receives an GWA command and returns the server's available watchers. If the listener cannot process the command
     * for whatever reason it must throw an ProtocolExecutionException.
     *
     * @return the server's available watchers
