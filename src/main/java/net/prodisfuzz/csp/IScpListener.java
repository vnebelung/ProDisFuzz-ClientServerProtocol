/*
 * This file is part of ProDisFuzz, modified on 14.07.18 16:38.
...
/**
 * This interface represents a listener for the SCP command.
 */
public interface IScpListener {

    /**
     * Receives an SCP command. The server must use the given connector parameters in the following fuzzing process. If
