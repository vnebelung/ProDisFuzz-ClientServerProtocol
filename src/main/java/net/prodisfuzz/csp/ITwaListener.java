/*
 * This file is part of ProDisFuzz, modified on 21.09.18 21:34.
...
/**
 * This interface represents a listener for the TWA command.
 */
public interface ITwaListener {

    /**
     * Receives an TWA command and returns the data the server did collect during the execution. If the listener cannot
